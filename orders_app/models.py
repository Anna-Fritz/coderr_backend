...
class Order(models.Model):
    customer_user = models.ForeignKey(UserProfile, related_name="customer_orders", on_delete=models.SET_NULL, null=True,)
    business_user = models.ForeignKey(UserProfile, related_name="business_orders", on_delete=models.SET_NULL, null=True,)
